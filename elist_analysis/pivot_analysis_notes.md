...
- **Month View**: Elist sees consistent, year-to-year surges in sales in Q4, suggesting opportunities to increase holiday and end of year marketing campaigns. The worst sales months are in February and September, where sales drop ~27% on average. These are key timeframes to improve on moving forward. 
